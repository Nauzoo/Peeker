<script>
    ...
    function goToDashboard() { currentScreen = page.dashboard; }
    function goToRegister() { currentScreen = page.register; }
    function goToLogin() { currentScreen = page.login; }
...
<main>
    ...
    {#if currentScreen === page.loading}
        <p style="text-align: center; margin-top: 50px;">Verificando sessão...</p>
